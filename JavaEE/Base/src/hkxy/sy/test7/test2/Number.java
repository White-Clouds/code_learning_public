...
public class Number implements Runnable {
    ...
    Number() {
        giveNumberThread = new Thread(this, "GiveNumberThread"); //【代码1】创建giveNumberThread,当前Number类的实例是giveNumberThread的目标对象
        guessNumberThread = new Thread(this, "GuessNumberThread"); //【代码2】创建guessNumberThread，当前Number类的实例是guessNumberThread的目标对象
        giveNumberThread.start();
        guessNumberThread.start();
    }
